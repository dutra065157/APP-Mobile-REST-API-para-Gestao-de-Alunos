...
def main(page: ft.Page):
    ...
    image = ft.Image(src=f"assets/karate.png",
                     fit=ft.ImageFit.CONTAIN, width=200, height=100,)
    ...
    texto = ft.Text("Academia de  judô", size=60,
                    weight=ft.FontWeight.BOLD, color=ft.colors.BLUE_GREY_300)

    row = ft.Row([image, texto],
